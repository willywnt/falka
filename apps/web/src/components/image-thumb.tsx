 ...
 * falling back to a product-shaped placeholder icon when there is none. Editing
 * the photo lives on the product detail page; everywhere else just displays it.
 */
