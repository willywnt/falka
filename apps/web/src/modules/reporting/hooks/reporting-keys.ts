...
export const reportingKeys = {
  ...
  netProfit: (params: Record<string, string>) => ['reporting', 'net-profit', params] as const,
  channels: (params: Record<string, string>) => ['reporting', 'channels', params] as const,
  inventoryValue: ['reporting', 'inventory-value'] as const,
  deadStock: (params: Record<string, string>) => ['reporting', 'dead-stock', params] as const,
  abc: (params: Record<string, string>) => ['reporting', 'abc', params] as const,
};
